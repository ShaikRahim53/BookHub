...
import com.rahim.bookhub.adapter.FavouriteRecyclerAdapter
...
class FavouritesFragment : Fragment() {
    ...
    class RetrieveFavourites(@SuppressLint("StaticFieldLeak") val context : Context): AsyncTask<Void, Void, List<BookEntity>>()
    {
